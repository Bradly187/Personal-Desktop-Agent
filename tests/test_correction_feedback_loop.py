...
async def test_correction_injects_corrected_and_retires_wrong():
    ...
    try:
        ...
        examples = await db.get_few_shot_examples(cmd, domain="command")
        ...
        counter = await db.get_few_shot_counterexamples(cmd, domain="command")
...
async def test_few_shot_ranking_prefers_more_similar():
    ...
    try:
        ...
        ranked = await db.get_few_shot_examples(q, n=2, domain="command")
