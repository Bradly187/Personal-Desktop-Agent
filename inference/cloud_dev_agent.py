...
(0.003 in + 0.0075 out ≈ $0.0105, plus a little for the system prompt + adaptive
...
# Default model — Claude Sonnet 4.6 ($3/$15 per MTok): strong free-form dev
# generation at lower cost than Opus, and the most capable dev model with access
# granted on the current Amazon Bedrock account (Opus 4.8 access is gated there).
# Override via the constructor.  Supports adaptive thinking (math/plan domains).
